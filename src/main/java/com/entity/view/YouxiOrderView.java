...
public class YouxiOrderView extends YouxiOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String youxiOrderValue;
		/**
		* 支付类型的值
		*/
		private String youxiOrderPaymentValue;
	...
	public YouxiOrderView() {

	}

	public YouxiOrderView(YouxiOrderEntity youxiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, youxiOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getYouxiOrderValue() {
				return youxiOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setYouxiOrderValue(String youxiOrderValue) {
				this.youxiOrderValue = youxiOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getYouxiOrderPaymentValue() {
				return youxiOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setYouxiOrderPaymentValue(String youxiOrderPaymentValue) {
				this.youxiOrderPaymentValue = youxiOrderPaymentValue;
			}
