...
public class YouxiCommentbackView extends YouxiCommentbackEntity implements Serializable {
	...
	public YouxiCommentbackView() {

	}

	public YouxiCommentbackView(YouxiCommentbackEntity youxiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, youxiCommentbackEntity);
