 ...
 */
@TableName("youxi")
public class YouxiEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Youxi{" +
            "id=" + id +
            ", youxiName=" + youxiName +
            ", youxiUuidNumber=" + youxiUuidNumber +
            ", youxiPhoto=" + youxiPhoto +
            ", youxiTypes=" + youxiTypes +
            ", youxiZuidipeizhi=" + youxiZuidipeizhi +
            ", youxiTuijianpeizhi=" + youxiTuijianpeizhi +
            ", youxiKaifashang=" + youxiKaifashang +
            ", youxiYuyan=" + youxiYuyan +
            ", youxiKongjian=" + youxiKongjian +
            ", youxiShoufa=" + youxiShoufa +
            ", youxiAddress=" + youxiAddress +
            ", youxiPrice=" + youxiPrice +
            ", youxiOldMoney=" + youxiOldMoney +
            ", youxiNewMoney=" + youxiNewMoney +
            ", youxiClicknum=" + youxiClicknum +
            ", youxiContent=" + youxiContent +
            ", shangxiaTypes=" + shangxiaTypes +
            ", youxiDelete=" + youxiDelete +
