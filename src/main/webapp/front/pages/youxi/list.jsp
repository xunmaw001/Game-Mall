                        ...
                        <div class="team-info">
                            <div class="team-row">
                                <div v-for="(item,index) in dataList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 team-grids">
                                    <div class="team-agile-img" @click="jumpCheck('../youxi/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
...
<script>
    ...
    // 当前表的字典表
        ...
        function youxiTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=youxi_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function pageList() {
            ...
            var youxiTypes = $("#youxiTypes").find("option:selected").val();
            if (youxiTypes != null && youxiTypes != "" && youxiTypes != "null") {
                param['youxiTypes'] = youxiTypes;
            }



            // 获取列表数据
            http.request('youxi/list', 'get', param, function(res) {
