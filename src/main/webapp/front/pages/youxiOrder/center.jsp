    ...
    <ul class="layui-nav layui-nav-tree">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="youxiOrderUuidNumber" id="youxiOrderUuidNumber" lay-verify="required" placeholder="订单号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="youxiOrderTruePrice" id="youxiOrderTruePrice"  lay-verify="required|double"   placeholder="实付价格" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="youxiOrderTypes" id="youxiOrderTypes">
                                    <option v-for="item in youxiOrderTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="youxiOrderPaymentTypes" id="youxiOrderPaymentTypes">
                                    <option v-for="item in youxiOrderPaymentTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`youxiOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
