...
<!-- 唯一uuid -->
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="detail.yonghuUuidNumber" type="text" name="yonghuUuidNumber" id="yonghuUuidNumber"  lay-verify="required"   placeholder="用户编号" autocomplete="off" class="layui-input" readonly="readonly">
                </div>
            </div>
            <div class="layui-form-item" pane>
...
<!-- 手机号 -->
    ...
    <!-- 身份证号 -->
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input <%--v-model="detail.age"--%> type="text" name="age" id="age" lay-verify="integer|required"   placeholder="年龄" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <select name="xueliTypes" id="xueliTypes" lay-filter="xueliTypes">
                        <option v-for="item in xueliTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                    </select>
                </div>
            </div>
<!-- 邮箱 -->
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate', 'tinymce'], function () {
       ...
       function xueliTypesSelect() {
           //填充下拉框选项
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueli_types", "GET", {}, (res) => {
               if(res.code == 0){
                   vue.xueliTypesList = res.data.list;
               }
           });
       }
