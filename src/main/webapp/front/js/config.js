...
var centerMenu = [
    ...
    ,{
        name: '游戏收藏',
        url: '../youxiCollection/list.jsp'
    }
    ,{
        name: '游戏订单',
        url: '../youxiOrder/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '游戏',
        url: './pages/youxi/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/youxishangcheng/jsp/login.jsp";
