    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑游戏评价</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">游戏评价管理</li>
                        <li class="breadcrumb-item active">编辑游戏评价</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">游戏评价信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 youxiCommentbackTextDiv">
                                        <label>评价内容</label>
                                        <textarea style="width: 450px"  id="youxiCommentbackText" name="youxiCommentbackText" class="form-control"placeholder="评价内容"></textarea>
                                    </div>
...
<script>
    ...
    var tableName = "youxiCommentback";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("youxiCommentback/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addyouxiCommentback');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                youxiId: "required",
                yonghuId: "required",
                youxiCommentbackText: "required",
                replyText: "required",
            },
            messages: {
                youxiId: "游戏不能为空",
                yonghuId: "用户不能为空",
                youxiCommentbackText: "评价内容不能为空",
                replyText: "回复内容不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addyouxiCommentback = window.sessionStorage.getItem("addyouxiCommentback");
        if (addyouxiCommentback != null && addyouxiCommentback != "" && addyouxiCommentback != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("youxiCommentback/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#youxiCommentbackText").val(ruleForm.youxiCommentbackText);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            $('#youxiCommentbackText').attr('readonly', 'readonly');
