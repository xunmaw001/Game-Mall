            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">游戏订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="youxiOrderUuidNumber" name="youxiOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.youxiOrderUuidNumber" readonly>
                                    </div>

                                <input id="youxiId" name="youxiId" v-model="ruleForm.youxiId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="youxiOrderTruePrice" name="youxiOrderTruePrice" class="form-control"
                                               v-model="ruleForm.youxiOrderTruePrice" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>订单类型</label>
                                    <input style="width: 450px" id="youxiOrderValue" name="youxiOrderValue" class="form-control"
                                           v-model="ruleForm.youxiOrderValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>支付类型</label>
                                    <input style="width: 450px" id="youxiOrderPaymentValue" name="youxiOrderPaymentValue" class="form-control"
                                           v-model="ruleForm.youxiOrderPaymentValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "youxiOrder/info/" + id,
